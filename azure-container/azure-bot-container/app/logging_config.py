"""
Logging setup for Azure Container Apps and local console compatibility.

Container Apps captures stdout/stderr into Log Analytics automatically (see
PYTHONUNBUFFERED=1 in the Dockerfile), so structured formatting isn't
