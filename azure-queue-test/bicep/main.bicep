...
param ingestFunctionAppName string = 'gti-teams-bot-ingest-test'

@description('Name of the Worker Function App (queue-triggered GTI processing).')
param workerFunctionAppName string = 'gti-teams-bot-worker-test'
...
@minValue(30)
@maxValue(1800)
param gtiTimeoutSeconds int = 180
...
param manifestSourceBaseUrl string = 'https://raw.githubusercontent.com/avadhsonagara/gti-team-bot/main/azure-queue-test/gti-teams-bot/teams-app-manifest'
...
param ingestCodeZipUrl string = 'https://raw.githubusercontent.com/avadhsonagara/gti-team-bot/main/azure-queue-test/gti-teams-bot/bot-ingest-function/code.zip'
...
param workerCodeZipUrl string = 'https://raw.githubusercontent.com/avadhsonagara/gti-team-bot/main/azure-queue-test/gti-teams-bot/bot-worker-function/code.zip'
