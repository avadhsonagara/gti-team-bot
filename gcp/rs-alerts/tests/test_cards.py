...
def test_card_basic_shape_and_view_in_gti_action():
    ...
    assert card["actions"] == [
        {"type": "Action.OpenUrl", "title": "View in GTI", "url": "https://www.virustotal.com/gui/alerts/abc123"}
    ]
...
def test_no_url_when_alert_id_unresolvable():
    """Verify no open URL action is generated when the alert ID cannot be resolved."""
